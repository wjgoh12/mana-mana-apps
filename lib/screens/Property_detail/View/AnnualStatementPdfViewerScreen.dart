...
class AnnualStatementPdfViewerFromMemory extends StatelessWidget {
  ...
  const AnnualStatementPdfViewerFromMemory(
      {super.key,
  ...
  void share(RenderBox box) async {
    ...
    File file = File(
        '${dir.absolute.path}/${property}_${unitType}_${unitNo}_$year.pdf');
