            ...
            child: Stack(
              ...
              child: Column(
                ...
                children: [
                  ...
                  buildInfoInRow(users.first.ownerFullName.toString().isEmpty || users.first.ownerFullName == null ? 'No Information' : users.first.ownerFullName.toString()),
                  buildInfoRow(Icons.phone, 'Contact No.'),
                  buildInfoInRow(users.first.ownerContact.toString().isEmpty || users.first.ownerContact == null ? 'No Information' : users.first.ownerContact.toString()),
                  buildInfoRow(Icons.email, 'Email'),
                  buildInfoInRow(users.first.ownerEmail.toString().isEmpty || users.first.ownerEmail == null ? 'No Information' : users.first.ownerEmail.toString()),
                  buildInfoRow(Icons.location_on_outlined, 'Address'),
                  buildInfoInRow(users.first.ownerAddress.toString().isEmpty || users.first.ownerAddress == null ? 'No Information' : users.first.ownerAddress.toString()),
                ],
              ),
            ),
                    ],
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  buildInfoInRow(OwnerProperty.first.bank.toString().isEmpty || OwnerProperty.first.bank == null ? 'No Information' : OwnerProperty.first.bank.toString()),                  
                  SizedBox(height: 8),
                  buildInfoInRow(OwnerProperty.first.accountnumber.toString().isEmpty || OwnerProperty.first.accountnumber == null ? 'No Information' : OwnerProperty.first.accountnumber.toString()),
                  SizedBox(height: 8),
