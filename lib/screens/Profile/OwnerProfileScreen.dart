...
class _OwnerProfileScreenState extends State<OwnerProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Owner\'s Profile', style: TextStyle(fontWeight: FontWeight.bold)),
        centerTitle: true,
        leading: IconButton(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Divider(color: Color(0XFF4313E9), thickness: 2),
              SizedBox(height: 16),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            TextButton.icon(
                              ...
                              icon: Icon(Icons.edit, color: Color(0XFF4313E9)),
                              label: Text('Edit', style: TextStyle(color: Color(0XFF4313E9))),
                            ),
                          ],
                        ),
                        SizedBox(height: 8),
              ...
              Card(
                ...
                elevation: 2,
                child: ListTile(
                  title: Text('SAMPLE - SCARLETZ -Type_A-11-03 Agreement'),
                  trailing: Text(
                    'PDF',
